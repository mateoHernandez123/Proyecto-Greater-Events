...
/**
 * Registro publico de usuarios finales (TP4). Crea el usuario en Keycloak via
 * admin client, le asigna el rol {@code user} y persiste la fila correspondiente
 * en la tabla {@code users}. Si la persistencia local falla, hace rollback en
 * Keycloak para evitar usuarios huerfanos.
 */
@Service
